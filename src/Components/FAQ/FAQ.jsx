          ...
          <div className="col-md-8">
            <Accordion defaultActiveKey="0">
              <Accordion.Item eventKey="0">
                <Accordion.Header style={{fontFamily:"'Inter', sans-serif"}}>What is the Reals Token? </Accordion.Header>
                <Accordion.Body>
              ...
              <Accordion.Item eventKey="1">
                ...
                <Accordion.Body>
                  <p className="acc_para">
                  We're launching the Reals Token with a presale to give everyone a chance to buy at a discounted price and be a part of the initial Market cap of $2.1 million before it goes public and explodes.
                  </p>
                </Accordion.Body>
              </Accordion.Item>
              <Accordion.Item eventKey="2">
                <Accordion.Header style={{fontFamily:"'Inter', sans-serif"}}>What exactly is Global Real Estate Marketplace staking, and when can you use it? </Accordion.Header>
                <Accordion.Body>
                  <p className="acc_para">
                  Staking allows users to lock away a specified amount of Reals Tokens in return for financial rewards to maximize the potential of their holdings. At its core, staking will offer a dual advantage; it serves as a mechanism for securing the network while simultaneously rewarding participants with additional tokens.  <br></br><br/>
